        ...
        <div class="col-12 col-md-8">
            <div class="app-card app-card-settings shadow-sm p-4">
                ...
                <div class="app-card-body">
                    <form class="settings-form" method="POST" action="{{ route('employers.update', $employers->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-1" placeholder="Entrer le nom "
                                name="firstName" required value="{{ $employers->nom }}">
                            @error('firstName')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-2" placeholder="Enrer le prenom "
                                name="lastName" value="{{ $employers->prenom }}" required>
                            @error('lastName')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="setting-input-3" placeholder="Entrer email"
                                name='email' value="{{ $employers->email }}">
                            @error('email')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-3" placeholder="Entrer le contact"
                                name='phone' value="{{ $employers->contact }}">
                            @error('phone')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-3"
                                placeholder="Entrer le montant journalier"
                                name='number'value="{{ $employers->montant_journalier }}">
                            @error('number')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
