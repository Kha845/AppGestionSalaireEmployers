                            ...
                            <tbody>
                                ...
                                @forelse ($employers as $employer)
                                    <tr>
                                        ...
                                        <td class="cell"><span class="badge bg-success">{{ $employer->contact }}</span>
                                        </td>
                                        <div>
                                            <td class="cell"><span
                                        ...
                                        <td class="cell"><a class="btn-sm app-btn-secondary"
                                                href="{{ route('employers.edit', $employer->id) }}">Editer</a></td>
                                        <td class="cell"><a class="btn-sm app-btn-secondary"
                                                href="{{ route('employers.delete', $employer->id) }} ">Supprimer</a></td>
                                    </tr>
