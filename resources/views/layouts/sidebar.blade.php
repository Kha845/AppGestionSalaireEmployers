    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <div class="app-auth-branding mb-4"><a class="app-logo" href="index.html">
                <img class="logo-icon me-2" src="https://ui-avatars.com/api/?name={{ AppNameGetter::getNameApp() ? AppNameGetter::getNameApp() :
                'Gestion de salaire et employers' }}" alt="logo"><img class="logo-icon me-2" src="assets/images/app-logo.svg" alt="logo"></a>
            </div>
            ...
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <a class="nav-link" href="{{ route('payment.index')}}">
                        ...
                        <span class="nav-link-text">Paiments</span>
                    </a><!--//nav-link-->
                </li><!--//nav-item-->
                <li class="nav-item has-submenu">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('admin.index') }}">Liste</a></li>
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('admin.create') }}">Ajout</a>
                            </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            ...
                            <li class="submenu-item"><a class="submenu-link"
                                    href="{{ route('employers.create') }}">Ajout</a>
                            </li>
